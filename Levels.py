...
class Level:
    ...
    def Load_LV14(self):
        ...
        for obj in self.LV14_map.objects:
            ...
            elif obj.name == "Top-Gun": Enemies((261,32),obj.image,(self.Lv14Shooters,self.LV14DeadlyBlocks),Name="Top-Gun",Direction=Vector2(0,4),Surface=(1,3),Scale=7)
            elif obj.name == "Right-FastGun": Enemies((617,259),obj.image,(self.LV14FastShooters,self.LV14DeadlyBlocks),Name="Right-FastGun",Direction=Vector2(-6,0),Surface=(3,1),Scale=7)
            elif obj.name == "Bottom-Gun": Enemies((356,493),obj.image,(self.Lv14Shooters,self.LV14DeadlyBlocks),Name="Bottom-Gun",Direction=Vector2(0,-3),Surface=(1,3),Scale=7)
            elif obj.name == "Bottom-FastGun": Enemies((424,493),obj.image,(self.LV14FastShooters,self.LV14DeadlyBlocks),Name="Bottom-FastGun",Direction=Vector2(0,-6),Surface=(1,3),Scale=7)
            elif obj.name == "Left-FastGun": Enemies((0,330),obj.image,(self.LV14FastShooters,self.LV14DeadlyBlocks),Name="Left-FastGun",Direction=Vector2(6,0),Surface=(3,1),Scale=7)
